...
router.post('/login', async (req, res) => {
  try {
    ...
    const token = jwt.sign(payload, '1234_KEY');
...
router.put('/update/:id', async (req, res) => {
  try {
    ...
    // NOTE: If password is updated, this route won't auto-hash.
    // Keep password changes in a separate endpoint if you want hashing.
